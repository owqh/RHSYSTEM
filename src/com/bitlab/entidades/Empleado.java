...
public class Empleado {
    ...
    public String toString() {
        ...
        empleados.append(" || ID: ").append(id_empleado).append("\n\r");
        empleados.append(" || Nombre: ").append(nombre_empleado).append("\n\r");
        empleados.append(" || Apellido: ").append(apellido_empleado).append("\n\r");
        empleados.append(" || Email: ").append(correo_empleado).append("\n\r");
        empleados.append(" || Telefono: ").append(telefono_empleado).append("\n\r");
        empleados.append(" || DUI: ").append(dui_empleado).append("\n\r");
        empleados.append(" || Dirreccion: ").append(direccion_empleado).append("\n\r");
        empleados.append(" || Fecha_Nacimiento: ").append(fecha_nac_empleado).append("\n\r");
        empleados.append(" || Fecha_Contratacion: ").append(fecha_contrat_empleado).append("\n\r");
        empleados.append(" || Sex_ID: ").append(sexIDempleado_fk).append("\n\r");
        empleados.append(" || Estado_Laboral: ").append(estadoEmpleado_fk).append("\n\r");
